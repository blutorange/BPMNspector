 ...
 * @version 1.0
 */
public class Ext050Test extends TestCase {

    private static final String ERR_MSG =
            "If a ReceiveTask references a message, at most one OutputSet must be defined " + "in the ioSpecification.";

    @Test
    public void testConstraintFail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT050_failure.bpmn"), 1);
