...
public class Ext018Test extends TestCase {
    ...
    public void testConstraintFailExclusiveGateway() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT018_failure_exclusiveGateway.bpmn"), 1);
        assertViolation(
    ...
    public void testConstraintFailParallelGateway() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT018_failure_parallelGateway.bpmn"), 1);
        assertViolation(
