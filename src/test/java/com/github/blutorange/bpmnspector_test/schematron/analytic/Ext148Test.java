 ...
 * @version 1.0
 */
public class Ext148Test extends TestCase {
    ...
    public void testConstraintFailCancelCatch() throws ValidationException {
        ...
        assertViolation(result.getViolations().get(0), ERR_MSG, "(//bpmn:intermediateCatchEvent)[1]", 7);
    }
    ...
    public void testConstraintFailCompensateCatch() throws ValidationException {
        ...
        assertViolation(result.getViolations().get(1), ERR_MSG, "(//bpmn:intermediateCatchEvent)[1]", 7);
    }
