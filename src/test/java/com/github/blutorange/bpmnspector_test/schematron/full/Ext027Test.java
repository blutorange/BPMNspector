...
public class Ext027Test extends TestCase {
    ...
    public void testConstraintFailChoreography() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT027_failure_choreography.bpmn"), 1);
    ...
    public void testConstraintFailGlobalConversation() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT027_failure_globalConversation.bpmn"), 1);
