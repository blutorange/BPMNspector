 ...
 * @version 1.0
 */
public class Ext035Test extends TestCase {

    private static final String ERR_MSG = "A Public process may not be marked as executable.";

    @Test
    public void testConstraintFail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT035_failure.bpmn"), 1);
        assertViolation(result.getViolations().get(0), ERR_MSG, "/bpmn:definitions/bpmn:process", 3);
    }
