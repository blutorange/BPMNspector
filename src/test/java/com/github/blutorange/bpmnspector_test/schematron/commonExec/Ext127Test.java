...
public class Ext127Test extends TestCase {
    ...
    public void testConstraintFailBoundary() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT127_failure_boundary.bpmn"), 1);
        assertViolation(
    ...
    public void testConstraintFailEndEvent() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT127_failure_endEvent.bpmn"), 1);
        assertViolation(
                result.getViolations().get(0),
                ERR_MSG,
    ...
    public void testConstraintFailIntCatch() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT127_failure_intCatch.bpmn"), 1);
        assertViolation(
                result.getViolations().get(0),
                ERR_MSG,
    ...
    public void testConstraintFailIntThrow() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT127_failure_intThrow.bpmn"), 1);
        assertViolation(
                result.getViolations().get(0),
                ERR_MSG,
    ...
    public void testConstraintFailStartEvent() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("EXT127_failure_startEvent.bpmn"), 1);
        assertViolation(
                result.getViolations().get(0),
                ERR_MSG,
