...
public class Ext106Test extends TestCase {
    ...
    public void testConstraintEventFail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("fail_cancel_end_event.bpmn"), 1);
    ...
    public void testConstraintEventRefFail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("fail_sub_process.bpmn"), 1);
        assertViolation(
