...
/**
 * Test class for testing the preprocessing step to be able to detect file-across errors
 *
...
public class PreProcessingTest extends TestCase {
    ...
    private static final String ERRORMESSAGE = "Referenced process must have at least one None Start Event";
    private static final String XPATHSTRING = "//bpmn:*[@id = 'PROCESS_1']";
    ...
    @Test
    public void testTargetNamespaceIdReplacements() throws ValidationException {
