 ...
 * @version 1.0
 */
public class Ext091Test extends TestCase {

    private static final String ERR_MSG =
            "sourceRef and targetRef of a DataAssociation must have the same ItemDefinition or a transformation must be present.";

    @Test
    public void testConstraintFailDifferentStructureRef() throws ValidationException {
        ValidationResultBuilder result =
                verifyInvalidResult(createFile("EXT091_failure_differentStructureRef.bpmn"), 1);
        assertViolation(
