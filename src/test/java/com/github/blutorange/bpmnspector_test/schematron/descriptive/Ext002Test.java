...
public class Ext002Test extends TestCase {
    ...
    public void testConstraintImport1Fail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("fail_import.bpmn"), 10);
    ...
    public void testConstraintImport2Fail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("fail_import2.bpmn"), 10);
    ...
    public void testConstraintImport3Fail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("fail_import3.bpmn"), 20);
    ...
    public void testConstraintImportUrlFail() throws ValidationException {
        ValidationResultBuilder result = verifyInvalidResult(createFile("fail_import_URL.bpmn"), 10);
