 ...
 * @version 1.0
 */
public class Ext012Test extends TestCase {
    ...
    public void testConstraintFailAssignment() throws ValidationException {
        ...
        assertViolation(
                ...
                ERR_MSG,
                "/bpmn:definitions/bpmn:process/bpmn:task/bpmn:dataInputAssociation/bpmn:assignment",
                21);
    }
    ...
    public void testConstraintFailStandardLoopCharacteristics() throws ValidationException {
        ...
        assertViolation(
                result.getViolations().get(0),
                ERR_MSG,
                "/bpmn:definitions/bpmn:process/bpmn:task/bpmn:standardLoopCharacteristics",
                10);
    }
    ...
    public void testConstraintFailTimerEventTimeCycle() throws ValidationException {
        ...
        assertViolation(
                result.getViolations().get(0),
                ERR_MSG,
                "/bpmn:definitions/bpmn:process/bpmn:intermediateCatchEvent/bpmn:timerEventDefinition",
                10);
    }
