 ...
 * @version 1.0
 */
public class Ext007Test extends AbstractArtifactSequenceFlowTest {

    private static final String ERROR_MESSAGE_ONE = "An Artifact MUST NOT be a source for a Sequence Flow";
