...
public class EXT098RemoveInvalidTypeFixer implements ViolationFixer {
    ...
    private final List<String> INVALID_START_EVENT_DEFINITIONS = Arrays.asList(
    ...
    public boolean fixSingleViolation(Document processAsDoc, String xPath) {
        ...
        elemsToRemove.forEach(e -> affectedStartEvent.removeChild(
                e.getName(), Namespace.getNamespace(ConstantHelper.BPMN_NAMESPACE_STRING)));
